...
<link rel="stylesheet" href="<?php echo _WEB_ROOT?>/public/assets/admin/css/list_product.css">
  <div class="wrap-form">
    <div class="main-info">
      ...
      <form action="<?php echo _WEB_ROOT?>/admin/product/confirmAddProduct" enctype="multipart/form-data"  id="addProductForm" method="post" class="product-form">
          ...
          <div class="group-input text">
              ...
              <input  type="text" id="productName" name="sp_ten" value="<?php echo !empty($msg['sp_ten'])?$msg['sp_ten']:false?>"  placeholder="san pham 1 .." class="form-input">
          </div>
          <div class="group-input text">
              <label for="productPrice" class="form-label">Giá:</label>
              <input  type="number" id="productPrice"  name="sp_gia" value="<?php echo !empty($msg['sp_gia'])?$msg['sp_gia']:false?>"  placeholder="500 000 ... VDN" class="form-input">
          </div>
          <div class="group-input img">
              <label for="">Chọn ảnh sản phẩm  <span style="font-size:13px" >(ít nhất 1 ảnh )</span></label> <br>
